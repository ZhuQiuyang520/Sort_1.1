...
public class CashOutEnter : MonoBehaviour
{
    ...
    void Start()
    {
        CashOutManager.RimIndicate()._CashOutEnter = this;
        OpenPanelBtn.onClick.AddListener(() => { UIBenefit.RimIndicate().WrapUILight(nameof(CashOutPanel)); });
        UpdateMoney();
    }
    ...
    public void UpdateMoney()
    {
        ...
        MoneyTextAnim = DOTween.To(() => MoneyStart, x => MoneyText.text = x.ToString("F2"), CashOutManager.RimIndicate().Money, 1f);
