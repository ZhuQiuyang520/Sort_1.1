...
/// 矩形遮罩镂空
/// </summary>
public class RiftOfferFire : MonoBehaviour
{
    public static RiftOfferFire instance;
...
[UnityEngine.Serialization.FormerlySerializedAs("Text")]
    ...
    public void Jade(GameObject _target)
    {
        ...
        else
        {
            ...
            float width = 1;
            float height = 1;
            Synonym[0] = new Vector3(pos.x - width, pos.y - height);
            Synonym[1] = new Vector3(pos.x - width, pos.y + height);
            Synonym[2] = new Vector3(pos.x + width, pos.y + height);
            Synonym[3] = new Vector3(pos.x + width, pos.y - height);
        }
        //计算高亮显示区域在画布中的范围
