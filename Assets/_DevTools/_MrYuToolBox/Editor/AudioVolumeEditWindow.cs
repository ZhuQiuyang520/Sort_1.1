...
public class AudioVolumeEditWindow : EditorWindow
{
    ...
    void refreshAudioData()
    {
        ...
        //UI
        foreach(object music in Enum.GetValues(typeof(RealmCare.UIMusic)))
        {
        ...
        // Scene
        foreach (object music in Enum.GetValues(typeof(RealmCare.SceneMusic)))
        {
            string name = music.ToString();
            if (name == "None") continue;
            AudioModel model = new AudioModel();
    ...
    public void SaveJson(string Filepath)
    {
        ...
        MergeDictionaries.Beast(dic, UIAudioGroup);
        MergeDictionaries.Beast(dic, SceneAudioGroup);
